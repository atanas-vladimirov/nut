 ...
 * containing data for one or all UPSes.
 */
static void display_json(void)
{
	 ...
	 * In single-host mode, just output the single UPS object.
	 */
	if (!monhost) {
		printf("{\"upses\": [\n");
	}

	/* Loop through all UPSes (in single-host mode, this is just one) */
